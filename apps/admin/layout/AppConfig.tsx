                ...
                <div className="grid">
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-indigo', 'light')}>
                            <Image src="/layout/images/themes/lara-light-indigo.png" width={32} height={32} alt="Lara Light Indigo" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-blue', 'light')}>
                            <Image src="/layout/images/themes/lara-light-blue.png" width={32} height={32} alt="Lara Light Blue" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-purple', 'light')}>
                            <Image src="/layout/images/themes/lara-light-purple.png" width={32} height={32} alt="Lara Light Purple" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-light-teal', 'light')}>
                            <Image src="/layout/images/themes/lara-light-teal.png" width={32} height={32} alt="Lara Light Teal" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-dark-indigo', 'dark')}>
                            <Image src="/layout/images/themes/lara-dark-indigo.png" width={32} height={32} alt="Lara Dark Indigo" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-dark-blue', 'dark')}>
                            <Image src="/layout/images/themes/lara-dark-blue.png" width={32} height={32} alt="Lara Dark Blue" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-dark-purple', 'dark')}>
                            <Image src="/layout/images/themes/lara-dark-purple.png" width={32} height={32} alt="Lara Dark Purple" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('lara-dark-teal', 'dark')}>
                            <Image src="/layout/images/themes/lara-dark-teal.png" width={32} height={32} alt="Lara Dark Teal" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('soho-light', 'light')}>
                            <Image src="/layout/images/themes/soho-light.png" width={32} height={32} alt="Soho Light" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('soho-dark', 'dark')}>
                            <Image src="/layout/images/themes/soho-dark.png" width={32} height={32} alt="Soho Dark" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('viva-light', 'light')}>
                            <Image src="/layout/images/themes/viva-light.svg" width={32} height={32} alt="Viva Light" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('viva-dark', 'dark')}>
                            <Image src="/layout/images/themes/viva-dark.svg" width={32} height={32} alt="Viva Dark" />
                        </button>
                    </div>
                </div>
                ...
                <div className="grid">
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('bootstrap4-light-blue', 'light')}>
                            <Image src="/layout/images/themes/bootstrap4-light-blue.svg" width={32} height={32} alt="Bootstrap Light Blue" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('bootstrap4-light-purple', 'light')}>
                            <Image src="/layout/images/themes/bootstrap4-light-purple.svg" width={32} height={32} alt="Bootstrap Light Purple" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('bootstrap4-dark-blue', 'dark')}>
                            <Image src="/layout/images/themes/bootstrap4-dark-blue.svg" width={32} height={32} alt="Bootstrap Dark Blue" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('bootstrap4-dark-purple', 'dark')}>
                            <Image src="/layout/images/themes/bootstrap4-dark-purple.svg" width={32} height={32} alt="Bootstrap Dark Purple" />
                        </button>
                    </div>
                </div>
                ...
                <div className="grid">
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('md-light-indigo', 'light')}>
                            <Image src="/layout/images/themes/md-light-indigo.svg" width={32} height={32} alt="Material Light Indigo" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('md-light-deeppurple', 'light')}>
                            <Image src="/layout/images/themes/md-light-deeppurple.svg" width={32} height={32} alt="Material Light DeepPurple" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('md-dark-indigo', 'dark')}>
                            <Image src="/layout/images/themes/md-dark-indigo.svg" width={32} height={32} alt="Material Dark Indigo" />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('md-dark-deeppurple', 'dark')}>
                            <Image src="/layout/images/themes/md-dark-deeppurple.svg" width={32} height={32} alt="Material Dark DeepPurple" />
                        </button>
                    </div>
                </div>
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('mdc-light-deeppurple', 'light')}>
                            <Image src="/layout/images/themes/md-light-deeppurple.svg" width={32} height={32} alt="Material Light Deep Purple" />
                        </button>
                    </div>
                    <div className="col-3">
                    ...
                    <div className="col-3">
                        <button className="p-link w-2rem h-2rem" onClick={() => _changeTheme('mdc-dark-deeppurple', 'dark')}>
                            <Image src="/layout/images/themes/md-dark-deeppurple.svg" width={32} height={32} alt="Material Dark Deep Purple" />
                        </button>
                    </div>
                </div>
            </Sidebar>
