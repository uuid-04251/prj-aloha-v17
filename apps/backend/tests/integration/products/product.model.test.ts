...
describe('Product Model', () => {
    ...
    describe('Indexes', () => {
        it.skip('should enforce unique constraint on sku', async () => {
            const productData1 = {
                name: 'Test Product 1',
                description: 'This is a test product description with enough content to meet the minimum requirements.',
                sku: 'UNIQUE137'
    ...
    describe('Text search', () => {
        ...
        it.skip('should find products by text search on name', async () => {
        ...
        it.skip('should find products by text search on description', async () => {
